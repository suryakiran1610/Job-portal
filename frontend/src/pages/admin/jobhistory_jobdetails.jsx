...
function Jobhistory_jobdetails() {
  ...
  useEffect(() => {
    ...
    MakeApiRequest(
      "get",
      `${config.baseUrl}adminn/jobhistoryviewjob/`,
      headers,
      params,
      {}
    )
        ...
        <div className="flex-grow w-full min-h-screen px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
          <div className="flex flex-col md:flex-row p-4">
            ...
            <div className="flex flex-col space-y-4 md:ml-4 w-full md:w-1/3">
              <div className="bg-white p-6 shadow-md rounded-sm overflow-hidden">
...
export default Jobhistory_jobdetails;
