      ...
      .then((response) => {
        ...
        setCompanyData((prevCompanyData) => ({
          ...
          company: prevCompanyData.company.map((company) =>
            company.id === companyId ? { ...company, is_active: true } : company
          ),
        }));
      })
      .catch((error) => {
    ...
    MakeApiRequest(
      ...
      .then((response) => {
        ...
        setCategoryData((prevCategoryData) => prevCategoryData.map((category) =>
          category.id === categoryId ? { ...category, isapproved: true } : category
        ));
      })
      .catch((error) => {
        console.error("Error:", error);
    ...
    <div>
      ...
      <div className="flex-grow h-screen overflow-y-auto md:p-8 p-4 ">
        <div className="flex items-center justify-between">
          ...
          <p onClick={deleteallnotification} className="cursor-pointer text-sm">
            Clear All
          </p>
        </div>
            ...
            <div key={index}>
              ...
              >
                ...
                <div className="pl-3 w-auto md:w-2/5 flex-col">
                  <div className="flex items-center justify-between">
                    ...
                    >
                      ...
                      {notification.message} on {notification.registereddate}
                    </p>
                  </div>
                </div>
                ...
                {companyData.company.find(
                  (company) =>
                    company.id === notification.companyid &&
              ...
              ):notification.notificationtype === 'add_jobcategory_request' ? (
                <div
                onClick={() => {
                  readed(notification.id);
                }}
              ...
              >
                ...
                {categoryData.find(
                  ...
                  <div className="flex cursor-pointer">
                    ...
                    <div className="flex flex-col items-center">
                      <div className="flex items-center justify-center w-7 h-7 border-2 hover:border-4 border-red-500 rounded-full">
                        <svg
                          onClick={() => {
                            handlecategorydeletemodal(notification.jobcategoryid);
                          }}
                          className="w-7 h-7 text-red-500"
                          fill="none"
                          stroke="currentColor"
                  ...
                  <div className="flex text-sm text-green-600">Approved</div>
                )}
