            ...
            <div className="max-w-4xl px-4 py-10 sm:px-6 lg:px-8 mx-auto">
              <div className="bg-white rounded-xl shadow p-4 sm:p-7 dark:bg-neutral-800">
                ...
                {education.map((edu, index) => (
                  <form key={edu.id}  onSubmit={(e) => handleSubmit(e, edu.id,index)} encType="multipart/form-data">
                    <div className="flex justify-between">
                    ...
                    <div className="grid sm:grid-cols-12 gap-2 sm:gap-6">
                      ...
                      <div className="sm:col-span-9">
                        <div className="flex text-xs">
                          <a
                            onClick={()=>{DownloadResume(edu.education_document)}}
            ...
            <div className="inline-block w-full max-w-2xl p-8 my-8 overflow-hidden text-left transition-all transform bg-white rounded-lg shadow-xl dark:bg-neutral-800 dark:border dark:border-neutral-700">
              ...
              <div className="mt-4">
                <p className="text-sm text-gray-500 dark:text-neutral-400">
                  Are you sure you want to delete this Education? All of the data will
